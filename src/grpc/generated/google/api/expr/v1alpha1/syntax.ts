...
export const Expr: MessageFns<Expr> = {
  encode(message: Expr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.exprKind?.$case) {
      case "constExpr":
        Constant.encode(message.exprKind.constExpr, writer.uint32(26).fork()).join();
        break;
      case "identExpr":
        Expr_Ident.encode(message.exprKind.identExpr, writer.uint32(34).fork()).join();
        break;
      case "selectExpr":
        Expr_Select.encode(message.exprKind.selectExpr, writer.uint32(42).fork()).join();
        break;
      case "callExpr":
        Expr_Call.encode(message.exprKind.callExpr, writer.uint32(50).fork()).join();
        break;
      case "listExpr":
        Expr_CreateList.encode(message.exprKind.listExpr, writer.uint32(58).fork()).join();
        break;
      case "structExpr":
        Expr_CreateStruct.encode(message.exprKind.structExpr, writer.uint32(66).fork()).join();
        break;
      case "comprehensionExpr":
        Expr_Comprehension.encode(message.exprKind.comprehensionExpr, writer.uint32(74).fork()).join();
        break;
    }
    return writer;
  },
  ...
  fromPartial(object: DeepPartial<Expr>): Expr {
    ...
    switch (object.exprKind?.$case) {
      case "constExpr": {
        if (object.exprKind?.constExpr !== undefined && object.exprKind?.constExpr !== null) {
          message.exprKind = { $case: "constExpr", constExpr: Constant.fromPartial(object.exprKind.constExpr) };
        }
        break;
      }
      case "identExpr": {
        if (object.exprKind?.identExpr !== undefined && object.exprKind?.identExpr !== null) {
          message.exprKind = { $case: "identExpr", identExpr: Expr_Ident.fromPartial(object.exprKind.identExpr) };
        }
        break;
      }
      case "selectExpr": {
        if (object.exprKind?.selectExpr !== undefined && object.exprKind?.selectExpr !== null) {
          message.exprKind = { $case: "selectExpr", selectExpr: Expr_Select.fromPartial(object.exprKind.selectExpr) };
        }
        break;
      }
      case "callExpr": {
        if (object.exprKind?.callExpr !== undefined && object.exprKind?.callExpr !== null) {
          message.exprKind = { $case: "callExpr", callExpr: Expr_Call.fromPartial(object.exprKind.callExpr) };
        }
        break;
      }
      case "listExpr": {
        if (object.exprKind?.listExpr !== undefined && object.exprKind?.listExpr !== null) {
          message.exprKind = { $case: "listExpr", listExpr: Expr_CreateList.fromPartial(object.exprKind.listExpr) };
        }
        break;
      }
      case "structExpr": {
        if (object.exprKind?.structExpr !== undefined && object.exprKind?.structExpr !== null) {
          message.exprKind = {
            $case: "structExpr",
            structExpr: Expr_CreateStruct.fromPartial(object.exprKind.structExpr),
          };
        }
        break;
      }
      case "comprehensionExpr": {
        if (object.exprKind?.comprehensionExpr !== undefined && object.exprKind?.comprehensionExpr !== null) {
          message.exprKind = {
            $case: "comprehensionExpr",
...
export const Expr_CreateStruct_Entry: MessageFns<Expr_CreateStruct_Entry> = {
  encode(message: Expr_CreateStruct_Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.keyKind?.$case) {
      case "fieldKey":
        ...
        break;
      case "mapKey":
        Expr.encode(message.keyKind.mapKey, writer.uint32(26).fork()).join();
        break;
    }
  ...
  fromJSON(object: any): Expr_CreateStruct_Entry {
    return {
      ...
      keyKind: isSet(object.fieldKey)
        ? { $case: "fieldKey", fieldKey: globalThis.String(object.fieldKey) }
        : isSet(object.mapKey)
  ...
  toJSON(message: Expr_CreateStruct_Entry): unknown {
    ...
    } else if (message.keyKind?.$case === "mapKey") {
  ...
  fromPartial(object: DeepPartial<Expr_CreateStruct_Entry>): Expr_CreateStruct_Entry {
    const message = createBaseExpr_CreateStruct_Entry();
    message.id = (object.id !== undefined && object.id !== null) ? Long.fromValue(object.id) : Long.ZERO;
    switch (object.keyKind?.$case) {
      case "fieldKey": {
        if (object.keyKind?.fieldKey !== undefined && object.keyKind?.fieldKey !== null) {
          message.keyKind = { $case: "fieldKey", fieldKey: object.keyKind.fieldKey };
        }
        break;
      }
      case "mapKey": {
        if (object.keyKind?.mapKey !== undefined && object.keyKind?.mapKey !== null) {
...
export const Expr_Comprehension: MessageFns<Expr_Comprehension> = {
  ...
  fromJSON(object: any): Expr_Comprehension {
    return {
      ...
      iterVar2: isSet(object.iterVar2) ? globalThis.String(object.iterVar2) : "",
...
export const Constant: MessageFns<Constant> = {
  encode(message: Constant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.constantKind?.$case) {
      ...
      case "boolValue":
        ...
        break;
      case "int64Value":
        writer.uint32(24).int64(message.constantKind.int64Value.toString());
        break;
      case "uint64Value":
        writer.uint32(32).uint64(message.constantKind.uint64Value.toString());
        break;
      case "doubleValue":
      ...
      case "bytesValue":
        ...
        break;
      case "durationValue":
        Duration.encode(message.constantKind.durationValue, writer.uint32(66).fork()).join();
        break;
      case "timestampValue":
        Timestamp.encode(toTimestamp(message.constantKind.timestampValue), writer.uint32(74).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.constantKind = { $case: "int64Value", int64Value: Long.fromString(reader.int64().toString()) };
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.constantKind = {
            $case: "uint64Value",
            uint64Value: Long.fromString(reader.uint64().toString(), true),
          };
          continue;
        }
        case 5: {
        ...
        case 7: {
          ...
          message.constantKind = { $case: "bytesValue", bytesValue: Buffer.from(reader.bytes()) };
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromPartial(object: DeepPartial<Constant>): Constant {
    const message = createBaseConstant();
    switch (object.constantKind?.$case) {
      case "nullValue": {
        if (object.constantKind?.nullValue !== undefined && object.constantKind?.nullValue !== null) {
          message.constantKind = { $case: "nullValue", nullValue: object.constantKind.nullValue };
        }
        break;
      }
      case "boolValue": {
        if (object.constantKind?.boolValue !== undefined && object.constantKind?.boolValue !== null) {
          message.constantKind = { $case: "boolValue", boolValue: object.constantKind.boolValue };
        }
        break;
      }
      case "int64Value": {
        if (object.constantKind?.int64Value !== undefined && object.constantKind?.int64Value !== null) {
          message.constantKind = { $case: "int64Value", int64Value: Long.fromValue(object.constantKind.int64Value) };
        }
        break;
      }
      case "uint64Value": {
        if (object.constantKind?.uint64Value !== undefined && object.constantKind?.uint64Value !== null) {
          message.constantKind = { $case: "uint64Value", uint64Value: Long.fromValue(object.constantKind.uint64Value) };
        }
        break;
      }
      case "doubleValue": {
        if (object.constantKind?.doubleValue !== undefined && object.constantKind?.doubleValue !== null) {
          message.constantKind = { $case: "doubleValue", doubleValue: object.constantKind.doubleValue };
        }
        break;
      }
      case "stringValue": {
        if (object.constantKind?.stringValue !== undefined && object.constantKind?.stringValue !== null) {
          message.constantKind = { $case: "stringValue", stringValue: object.constantKind.stringValue };
        }
        break;
      }
      case "bytesValue": {
        if (object.constantKind?.bytesValue !== undefined && object.constantKind?.bytesValue !== null) {
          message.constantKind = { $case: "bytesValue", bytesValue: object.constantKind.bytesValue };
        }
        break;
      }
      case "durationValue": {
        if (object.constantKind?.durationValue !== undefined && object.constantKind?.durationValue !== null) {
          message.constantKind = {
            $case: "durationValue",
      ...
      case "timestampValue": {
        if (object.constantKind?.timestampValue !== undefined && object.constantKind?.timestampValue !== null) {
...
export const SourceInfo: MessageFns<SourceInfo> = {
  encode(message: SourceInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.extensions) {
      SourceInfo_Extension.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const SourceInfo_Extension: MessageFns<SourceInfo_Extension> = {
  encode(message: SourceInfo_Extension, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
    ...
    if (message.version !== undefined) {
      SourceInfo_Extension_Version.encode(message.version, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const SourceInfo_Extension_Version: MessageFns<SourceInfo_Extension_Version> = {
  encode(message: SourceInfo_Extension_Version, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.major.equals(Long.ZERO)) {
      writer.uint32(8).int64(message.major.toString());
    }
    if (!message.minor.equals(Long.ZERO)) {
      writer.uint32(16).int64(message.minor.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.major = Long.fromString(reader.int64().toString());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.minor = Long.fromString(reader.int64().toString());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
