...
export const PermissionLookupEntityRequest = {
  encode(message: PermissionLookupEntityRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.scope).forEach(([key, value]) => {
      PermissionLookupEntityRequest_ScopeEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).ldelim();
    });
...
export const PermissionLookupEntityRequest_ScopeEntry = {
  encode(message: PermissionLookupEntityRequest_ScopeEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      StringArrayValue.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PermissionLookupEntityRequest_ScopeEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PermissionLookupEntityResponse = {
  ...
  fromJSON(object: any): PermissionLookupEntityResponse {
    return {
      entityIds: Array.isArray(object?.entity_ids) ? object.entity_ids.map((e: any) => String(e)) : [],
      continuousToken: isSet(object.continuous_token) ? String(object.continuous_token) : "",
    };
  },
...
export const PermissionLookupEntityStreamResponse = {
  ...
  fromJSON(object: any): PermissionLookupEntityStreamResponse {
    return {
      entityId: isSet(object.entity_id) ? String(object.entity_id) : "",
      continuousToken: isSet(object.continuous_token) ? String(object.continuous_token) : "",
    };
  },
...
export const PermissionEntityFilterRequest = {
  encode(message: PermissionEntityFilterRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.entrance !== undefined) {
      Entrance.encode(message.entrance, writer.uint32(26).fork()).ldelim();
    }
    if (message.subject !== undefined) {
    ...
    Object.entries(message.scope).forEach(([key, value]) => {
      PermissionEntityFilterRequest_ScopeEntry.encode({ key: key as any, value }, writer.uint32(50).fork()).ldelim();
    });
    if (message.cursor !== "") {
...
export const PermissionEntityFilterRequest_ScopeEntry = {
  encode(message: PermissionEntityFilterRequest_ScopeEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PermissionEntityFilterRequest_ScopeEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PermissionLookupSubjectResponse = {
  ...
  fromJSON(object: any): PermissionLookupSubjectResponse {
    return {
      subjectIds: Array.isArray(object?.subject_ids) ? object.subject_ids.map((e: any) => String(e)) : [],
      continuousToken: isSet(object.continuous_token) ? String(object.continuous_token) : "",
    };
  },
...
export const SchemaPartialWriteRequest = {
  encode(message: SchemaPartialWriteRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.tenantId !== "") {
      writer.uint32(10).string(message.tenantId);
    }
    if (message.metadata !== undefined) {
      SchemaPartialWriteRequestMetadata.encode(message.metadata, writer.uint32(18).fork()).ldelim();
    }
    Object.entries(message.partials).forEach(([key, value]) => {
      SchemaPartialWriteRequest_PartialsEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).ldelim();
    });
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SchemaPartialWriteRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaPartialWriteRequest_PartialsEntry = {
  encode(message: SchemaPartialWriteRequest_PartialsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      Partials.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SchemaPartialWriteRequest_PartialsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaPartialWriteRequestMetadata = {
  encode(message: SchemaPartialWriteRequestMetadata, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.schemaVersion !== "") {
      writer.uint32(10).string(message.schemaVersion);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SchemaPartialWriteRequestMetadata {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaPartialWriteResponse = {
  encode(message: SchemaPartialWriteResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.schemaVersion !== "") {
      writer.uint32(10).string(message.schemaVersion);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SchemaPartialWriteResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TenantDeleteResponse = {
  ...
  fromJSON(object: any): TenantDeleteResponse {
    return { tenantId: isSet(object.tenant_id) ? String(object.tenant_id) : "" };
  },
