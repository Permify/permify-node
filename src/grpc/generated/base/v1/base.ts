...
export const Entrance = {
  encode(message: Entrance, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.type !== "") {
      writer.uint32(10).string(message.type);
    }
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Entrance {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Partials = {
  encode(message: Partials, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Partials {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Partials {
    return {
      write: Array.isArray(object?.write) ? object.write.map((e: any) => String(e)) : [],
      delete: Array.isArray(object?.delete) ? object.delete.map((e: any) => String(e)) : [],
      update: Array.isArray(object?.update) ? object.update.map((e: any) => String(e)) : [],
    };
  },
